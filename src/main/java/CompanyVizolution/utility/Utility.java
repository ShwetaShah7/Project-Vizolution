package CompanyVizolution.utility;


import CompanyVizolution.browserfactory.ManageBrowser;
...
//***************************** Is Display Methods **********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/CompanyVizolution/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/CompanyVizolution/screenshots/" + screenshotName + dateName + ".png";
    ...
    public void selectProduct(List<WebElement> element, String nameProduct) throws InterruptedException {
...
//    ************** Method to Scroll Down ******************
    public void scrollDownTo() throws InterruptedException {
...
//*************** Method for picking Dates **************
    ...
    public void selectDate() throws InterruptedException {
        ...
        while (true) {
            String monthYear = driver.findElement(By.xpath("//td[@class='monthTitle']")).getText(); // jun 2024
        ...
        List<WebElement> listOfDates = driver.findElements(By.xpath("//div[@id='rb-calendar_onward_cal']/table//td"));
